...
int LoadVersion0(string input, string output, string writefile, int verbose){
		...
		//Model ourModel(return_string.c_str());
		...
		Shader ourShader("../src/3.1.materials.vs", "../src/3.1.materials.fs");
		Shader lampShader("../src/3.1.lamp.vs", "../src/3.1.lamp.fs");
...
void ComputeOpenGL_FromCVParameters(Matrix3d& K, MatrixXd& Rt, Vector3d& C, glm::mat4& opengl_intrinsics,
	...
	// can negate second row of ndc to have the coordinates match OpenCV.
